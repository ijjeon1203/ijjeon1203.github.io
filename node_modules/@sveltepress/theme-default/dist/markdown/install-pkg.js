                    ...
                    if (textNode && textNode.type === 'text') {
                        ...
                        if (matches) {
                            ...
                            if (pkgNameMaybeWithCustomScript) {
                                ...
                                var wrapWithSlot = function (slotName, installScript) {
                                    return {
                                        type: 'InstallPkg',
                                        data: {
                                            hName: 'div',
                                        ...
                                        children: [{
                                                type: 'code',
                                                lang: 'sh',
                                                value: "".concat(slotName, " ").concat(customScript_1 || installScript, " ").concat(pkgName_1),
                                            }],
                                    };
                                };
                                var npmNode = wrapWithSlot('npm', 'install --save');
                                var yarnNode = wrapWithSlot('yarn', 'add');
                                var pnpmNode = wrapWithSlot('pnpm', 'install');
