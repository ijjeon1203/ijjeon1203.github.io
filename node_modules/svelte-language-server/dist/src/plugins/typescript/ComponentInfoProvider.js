...
class JsOrTsComponentInfoProvider {
    ...
    static create(lang, def) {
        ...
        const defClass = (0, utils_2.findContainingNode)(sourceFile, def.textSpan, (node) => typescript_1.default.isClassDeclaration(node) || typescript_1.default.isTypeAliasDeclaration(node));
        if (!defClass) {
            return null;
        }
