...
function getComponentAtPosition(lang, doc, tsDoc, originalPosition) {
    ...
    while (def1 != null &&
        def1.kind !== typescript_1.default.ScriptElementKind.classElement &&
        (def2 == null ||
            def2.kind !== typescript_1.default.ScriptElementKind.constElement ||
    ...
    return ComponentInfoProvider_1.JsOrTsComponentInfoProvider.create(lang, def1 || def2);
}
